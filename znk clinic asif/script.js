// ===================================
// ZNK Clinic - Interactive JavaScript
// ===================================
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (appointmentForm) {
        ...
        appointmentForm.addEventListener('submit', function(e) {
            ...
            let message = `*ZNK Clinic - Appointment Request*%0A%0A`;
    ...
    if (contactForm) {
        contactForm.addEventListener('submit', function(e) {
            ...
            // Create WhatsApp message
            let whatsappMsg = `*ZNK Clinic - Contact Form*%0A%0A`;
    ...
    console.log('%c🏥 ZNK Clinic', 'font-size: 24px; font-weight: bold; color: #2196F3;');
